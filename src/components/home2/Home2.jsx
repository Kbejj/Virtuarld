    ...
    <section className='about2__section'>
      ...
      <div className="container about2__container">
        ...
        <div className='about2__right'>
          <h3> <span> Virtuarld </span>aims to solve 2 main problems, </h3>
          <ul>
            <h4>
              <li>• Distant Relations: Virtuarld will enhance the online interaction experience with your friends from all over the world; </li>
